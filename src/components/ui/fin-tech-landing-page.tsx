...
import { ArrowUpRight, Landmark, LogIn, ShieldCheck, UserPlus } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-[#F3F5F7]">
      ...
      <nav className="mx-auto flex w-full max-w-[1180px] items-center justify-between px-4 py-6 md:px-0">
        ...
        <div className="hidden gap-2 md:flex">
          <button className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm text-slate-700 hover:bg-white">
        ...
        <div className="flex flex-col justify-center space-y-8 pr-2">
          <div>
            ...
            <p className="mt-4 max-w-md text-slate-600">
              ...
              <span className="font-medium text-slate-900">moneyflow</span> for fast and
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          >
            ...
            <div className="mt-2 text-3xl font-semibold tracking-tight">
              $50,240{" "}
              <span className="align-middle text-sm font-medium text-slate-400">USD</span>
            </div>
